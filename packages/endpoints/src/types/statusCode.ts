/**
 * @see https://spec.openapis.org/oas/v3.1.1.html#http-status-codes
...
export const statusCodes = {
  ...
  413: 'Content Too Large' as const,
...
export type StatusCodeMap = typeof statusCodes
export type StatusCode = keyof typeof statusCodes
export type StatusDescription = (typeof statusCodes)[keyof typeof statusCodes]
